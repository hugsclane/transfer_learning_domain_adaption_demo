...
- Revolving utilization \[ $ru=\frac{\text{bal}}{\text{cred_lim}}$ \] total_credit_utilized is defined as being the total credit balance, or \[$\text{total_credit}-\text{balance}$\] so Revolving_utilization in this data set should be calculable as \[$ru=\frac{totalcredit-balance}{credlim}$\]
