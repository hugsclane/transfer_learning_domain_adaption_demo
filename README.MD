...
- Revolving utilization \[ $ru=\frac{\text{bal}}{\text{cred lim}}$ \] total_credit_utilized is defined as being the total credit balance, or \[ $\text{total credit}-\text{balance}$ \] so Revolving_utilization in this data set should be calculable as \[ $ru=\frac{\text{total credit}-\text{balance}}{\text{credit limit}}$ \]
