...
- Revolving utilization $ru=\frac{bal}{credlim}$  total_credit_utilized is defined as being the total credit balance, or $\totalcredit-balance$ so Revolving_utilization in this data set should be calculable as $ru=\frac{totalcredit-balance}}{credlim}$ 
